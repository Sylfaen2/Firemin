...
Func _Localization_Preferences()
	...
	$g_aLangPreferences[4]  = _Localization_Load("Preferences", "Group_Extended_Processes", "Extended Processes")
	$g_aLangPreferences[5]  = _Localization_Load("Preferences", "Group_Cache", "Cache")
	$g_aLangPreferences[6]  = _Localization_Load("Preferences", "Group_Language", "Language")
	$g_aLangPreferences[7]  = _Localization_Load("Preferences", "Label_Extended_Processes", "Language")
	$g_aLangPreferences[8]  = _Localization_Load("Preferences", "Checkbox_Cache_Exit", " Clear cache on exit")
	$g_aLangPreferences[9]  = _Localization_Load("Preferences", "Label_Cache_Size", "Cache Size: %s KB")
	$g_aLangPreferences[10] = _Localization_Load("Preferences", "Button_Cache_Clear", "Clear Cache")
	...
	$g_aLangPreferences[18] = _Localization_Load("Preferences", "Label_Cache_Cleared", "Cache cleared")
