...
Func _Localization_Preferences()
	...
	$g_aLangPreferences[5]  = _Localization_Load("Preferences", "Checkbox_Notifications", "Show tray notifications")
	$g_aLangPreferences[6]  = _Localization_Load("Preferences", "Label_Extended_Processes", "Language")
	$g_aLangPreferences[7]  = _Localization_Load("Preferences", "Label_Language_Message", "Select the language you prefer and press the %s button to continue. (Restart Required)")
	$g_aLangPreferences[8]  = _Localization_Load("Preferences", "Button_Save", "Save")
	$g_aLangPreferences[9]  = _Localization_Load("Preferences", "Button_Cancel", "Cancel")
	$g_aLangPreferences[10] = _Localization_Load("Preferences", "Label_Updated", "Preferences Updated")
