...
Func _Localization_Menus()
	...
	$g_aLangMenus[7]  = _Localization_Load("Menus", "Help_Contact", "&Contact %{Company.Name}")
...
Func _Localization_Preferences()
	...
	$g_aLangPreferences[2]  = _Localization_Load("Preferences", "Tab_Language", "Language")
	$g_aLangPreferences[3]  = _Localization_Load("Preferences", "Group_Extended_Processes", "Extended Processes")
	$g_aLangPreferences[4]  = _Localization_Load("Preferences", "Group_Language", "Language")
	$g_aLangPreferences[5]  = _Localization_Load("Preferences", "Label_Extended_Processes", "Language")
	$g_aLangPreferences[6] = _Localization_Load("Preferences", "Label_Language_Message", "Select the language you prefer and press the %s button to continue. (Restart Required)")
	$g_aLangPreferences[7] = _Localization_Load("Preferences", "Button_Save", "Save")
	$g_aLangPreferences[8] = _Localization_Load("Preferences", "Button_Cancel", "Cancel")
	$g_aLangPreferences[9] = _Localization_Load("Preferences", "Label_Updated", "Preferences Updated")
	$g_aLangPreferences[10] = _Localization_Load("Preferences", "Label_Logging_Cleared", "Logging cleared")
	$g_aLangPreferences[11] = _Localization_Load("Preferences", "MsgBox_Language_Title", "Language Changed")
	$g_aLangPreferences[12] = _Localization_Load("Preferences", "MsgBox_Language_Message", "The selected language has changed. Complete Internet Repair should be restarted for the chosen language to take effect.")
	$g_aLangPreferences[13] = _Localization_Load("Preferences", "MsgBox_Closing_Title", "Closing %{Program.Name}")
	$g_aLangPreferences[14] = _Localization_Load("Preferences", "MsgBox_Closing_Message", "Would you like to close %{Program.Name} now?")
